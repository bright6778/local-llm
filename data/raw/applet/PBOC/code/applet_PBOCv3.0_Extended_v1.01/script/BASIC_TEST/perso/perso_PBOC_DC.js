...
data = TLV('82',   '7D00') // Application Interchange Profile
...
data = TLV('9F51', '0156') // Application Currency Code
	 + TLV('9F52', 'A200') // Application Default Action (ADA)
...
data = TLV('A5',   
		 ...
		 + TLV('9F12', '4341524420494D4147452030303232') // Application Preferred Name
