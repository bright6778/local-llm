// Test Name  : OnlineOnlyQvsdcUsingCryptogram17
// Card Image : PBOC-PSO-037
// Reference  : VCPS 2CB.005.00.00
// Card Conf  : Transaction Currency Code and Card Additional Process
// Condition  : LT sends a SELECT command on PPSE

include("_PBOC_COMMON.js");

print('\n* Test Case : qPBOC-PDOL-002');
...
//add according to vcps testplan, ysnam 2013.02.18
//Verify the Condition tag
if(lookup_BER_TLV(value_A5, "87", RETURN_VALUE) == "")
	error("The template 'A5' should include tag '87'(Application Priority Indicator)");

//Verify the Optional tag
if(lookup_BER_TLV(value_A5, "5F2D", RETURN_VALUE) == "")
	error("The template 'A5' should include tag '5F2D'(Language Preference)");