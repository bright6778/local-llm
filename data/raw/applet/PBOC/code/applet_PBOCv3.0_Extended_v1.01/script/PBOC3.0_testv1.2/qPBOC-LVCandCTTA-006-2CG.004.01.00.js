...
print('\n* Test Case : qPBOC-LVCandCTTA-006-2CG.004.01.00');

print('\n* Power on the Card(ATR)');
reset();
print('\n* Case 01: Amount, Authorised (1050) > VLP Single Transaction Limit');
select_PPSE();
assertSW('9000');
select_PBOC();
assertSW('9000');

Amount_Authorised = '000000003500';
