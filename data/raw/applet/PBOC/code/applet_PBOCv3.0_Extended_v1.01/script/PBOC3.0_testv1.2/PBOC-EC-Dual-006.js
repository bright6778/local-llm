/*******************************************
 Test Name  : PBOC E-Cash Dual Currency (EC 06)
 Objective  : A DUAL EC card processes a transaction as EC Online when (DUAL EC BALANCE -  Amount Authorized) < EC Reset Threshold 

*******************************************/
include("_PBOC_COMMON.js");

print('\n* Test Case : EC-Dual 006');
