...
data = TLV('82',   '7000') // Application Interchange Profile
	 ...
	 + TLV('94',   '1003090018030300') // Application File Locator
store('00', '9207', data);

// DGI 9208
data = TLV('82',   '7000') // Application Interchange Profile
	 + TLV('94',   '280309001801010118030300') // Application File Locator
...
// DGI 0208
data = TLV('70',   
		   TLV('9F4A', '9F4A0182') // Static Data Authentication Tag List
		)
store('00', '0208', data);
...
// DGI A001 : CAPP Data
data = '15010000FF000016010000FF000017010000FF000019010000FF00001E020000800A80';
store('60', 'A001', data);

// DGI 8020 : The opening of the application file extension key checksum value
...
// DGI 9020 : The opening of the application file extension key
...
data = TLV('9F51', '0156') // Application Currency Code
	 ...
	 + TLV('5F34', '01') // PAN Sequence Number
	 + TLV('9F76', '0000')
	 + TLV('DF62', '000000000000')
	 + TLV('DF71', '0344')
	 + TLV('DF79', '000000200000')
	 + TLV('DF77', '000001000000')
	 + TLV('DF78', '000000200000')
	 + TLV('DF76', '000000006000')
	 + TLV('DF72', '000000200000')
store('00', '0E01', data);
