/*******************************************
 Test Name  : CheckSupportMSD
 Card Image : PBOC-PSO-031
 Reference  : VCPS 2CD.025.00.00
...
if((AIP_BYTE2 & BIT_MASK_8) == 0)
	error("AIP byte 2 bit 8 (MSD is supported) shall be '1'.");
