...
print('\n* Test Case : qPBOC-Extended-IMAGE47-001');
print("\n* ******************************");
print("\n* Transaction 1");
print("\n* ******************************");
...
Transaction_Currency_Code = Terminal_Country_Code = APP_CURRENCY_CODE;send_GPO_new();
assertSW("9000");
...
if (Value_9F5D!="000000040000"){
		error("Available Funds is not correct - " + Value_9F5D);
}
...
if (Value_9F5D!="000000020000"){ // for 2nd Currency
		error("Available Funds is not correct - " + Value_9F5D);
}
Value_DF83=send('80CADF8300');
Value_DF83=Value_DF83.substr(6,12);
if (Value_DF83!="000000000000"){
		error("DF83 is not correct");
}
...
print("\n* ******************************");
CAPP_ID_DF60='03';
Amount_Authorised = '000000010000';
