...
{		
	...
	if(DOL_DATA['DF69'] == '01'){
		...
		var ICC_PK_M = retrieve_ICC_PK_M(issuer_PK_M, RES_DATA[tag_Issuer_PK_E]);
		// Verify Singed Dynamic Application Data
		return validate_SDAD_for_DDA(ICC_PK_M, RES_DATA[tag_ICC_PK_E]);
	}
}
...
{		
	...
	if(DOL_DATA['DF69'] == '01'){
		...
		var ICC_PK_M = retrieve_ICC_PK_M(issuer_PK_M, RES_DATA[tag_Issuer_PK_E]);
		// Verify Singed Dynamic Application Data
		validate_SDAD_for_fDDA(ICC_PK_M, RES_DATA[tag_ICC_PK_E]);
	}
}
