include("_PBOC_CONF_FOR_EXTENDED.js");
...
function select_PBOC()
{
	...
	print("          Tag DF61 : Len : " + lookup_BER_TLV(value_BF0C, "DF61", RETURN_LENGTH) + ", Value : " + Value_DF61);
...
function reset_VLP_Funds(VLP_Funds){
	...
	init(contactless[0], contactless[1]);
	print("***********************CAUTION!!!************************");
