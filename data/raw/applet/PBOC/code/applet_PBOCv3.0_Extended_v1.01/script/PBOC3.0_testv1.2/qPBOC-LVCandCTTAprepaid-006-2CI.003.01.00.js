...
print('\n* Test Case : qPBOC-LVCandCTTAprepaid-006-2CI.003.01.00');
...
//////////////////////// Case 02 ////////////////////////////
print("\n* Case 02 : Amount, Authorised > CTTAUL");
reset();
select_PBOC();
assertSW('9000');
...
function check_result(GPOresponse){
	...
	CTTAL = lookup_BER_TLV(send_GetData("9F5C"), "9F5C", RETURN_VALUE);	
	
	checkIAD("0701010380200001", "0701110380200001", 8);
	
	if(AOSA != CTTAL) error("AOSA('9F5D') shell be same as the CTTAUL('9F5C')")
