/*******************************************
 Test Name  : qVSDC Low Value Check - Offline processing (Decline Transaction
 Card Image : PBOC-PSE-037-(LVC)
 Reference  : VCPS 2CF.007.00.00
...
check_result(GPOresponse, VLP_Funds);
...
function check_result(GPOresponse, VLP_Funds){
		...
		checkIAD("07010103802000010A01", "07011103802000010A01", 10);		
		...
		print("[User Check] Compare and verify the card response data for the tags '57' and '5F34' with the card image personalization data");
		//pause();
