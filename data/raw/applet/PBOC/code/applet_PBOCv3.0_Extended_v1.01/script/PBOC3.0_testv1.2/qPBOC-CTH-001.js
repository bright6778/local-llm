/*******************************************
 Test Name  : withCLPBOCpath
 Card Image : PBOC-PSO-031
 Reference  : VCPS 2CD.007.00.00
 Card Conf  : N/A
...
if(AFL.length % 8 != 0)
	error("Length of AFL should be multiple of 4.");
if(AFL.length > 504)
	error("Length of AFL should be less than or equal to 252");
