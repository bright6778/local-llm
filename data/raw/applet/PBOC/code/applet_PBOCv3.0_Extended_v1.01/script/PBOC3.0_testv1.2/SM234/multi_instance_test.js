...
// install
var seq = 0;
perso('A000000333010101');

seq = 0;
perso('A000000333010102');

seq = 0;
perso('A000000333010103');


// Transaction
// PBOC - International
DOL_DATA['DF69'] = '00';
test_PBOC('A000000333010102');
test_PBOC('A000000333010103');
test_PBOC('A000000333010101');
// PBOC - Chinese
DOL_DATA['DF69'] = '01';
test_PBOC('A000000333010101');
test_PBOC('A000000333010102');
...
// qPBOC - International
DOL_DATA['DF69'] = '00';
test_qPBOC('A000000333010103');
test_qPBOC('A000000333010102');
test_qPBOC('A000000333010101');
// qPBOC - Chinese
DOL_DATA['DF69'] = '01';
test_qPBOC('A000000333010103');
test_qPBOC('A000000333010101');
...
select('a0');
auth();
send('80E400000A4F08A000000333010103');
send('80E400000A4F08A000000333010102');
...
data = '06A00000033301'+'07A0000003330101'+toHex(aid.length/2)+aid+ '011002C90000';
...
function test_PBOC(aid){
	...
	send_GenAC('80', CDOL1); // 1st GenAC with CDA
