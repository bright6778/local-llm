/*******************************************
 ...
 Card Conf  : [Card Additional Process '9F68']
			  ...
			  [Cumulative Transaction Total Amount Upper Limit '9F5C'] personalized                    
 *******************************************/

include("_PBOC_COMMON.js");

print('\n* Test Case : qPBOC-LVCandCTTAprepaid-010-2CI.005.01.00');
...
function check_result(GPOresponse){
	...
	CTTAUL = lookup_BER_TLV(send_GetData("9F5C"), "9F5C", RETURN_VALUE);
	
	if(AOSA != CTTAUL-parseInt(Amount_Authorised,10)) error("AOSA('9F5D') shell be same as the CTTAUL('9F5C') - Amount, Authorised")
