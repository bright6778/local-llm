/*******************************************
 Test Name  : GPOresponseForOnlineTransactionQPBOC-ConditionalData
 Card Image : PBOC-PSO-031
 Reference  : VCPS 2CD.016.00.00
 Card Conf  : [Application PAN Sequence Number] & 
              [Card Transaction Qualifiers] &
              [Available Offline Spending Amount] supported
 Condition  : LT sends a SELECT command on PPSE
*******************************************/

include("_PBOC_COMMON.js");

print('\n* Test Case : qPBOC-GPO-004');
