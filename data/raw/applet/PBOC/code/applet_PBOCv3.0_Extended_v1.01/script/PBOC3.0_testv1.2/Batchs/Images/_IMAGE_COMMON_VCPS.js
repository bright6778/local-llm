...
var INSTALL_PARAMETER_LONG_KEY	=	'01100BC909080300000001B0000000'; // Native
var INSTALL_PARAMETER_NORMAL	=	'01100BC909000000000001B0000000'; // Native
//var INSTALL_PARAMETER_LONG_KEY	=	'01100BC909080304000001B0000000'; // Java
//var INSTALL_PARAMETER_NORMAL	=	'01100BC909000004000001B0000000'; // Java
...
var CVN_01 = 'cvn_01';
var CVN_17 = 'cvn_17';
//19/12/2013 09:43mllee var cvn = CVN_01;
var cvn;
...
function select_image(num) {
	...
	switch (num) {
		...
		case 2:
			QPBOC_CARD_ADDITIONAL_PROCESS = '8B00F000';
			QPBOC_TRANSACTION_PROPERTY = '3000';
			QPBOC_EC_BALANCE = '000000005000';
			issuer_key = CRYPTO_RSA_1024;
			ic_key = CRYPTO_RSA_1024;
			break;
			
		case 3:
			QPBOC_CARD_ADDITIONAL_PROCESS = '4B00F000';
			QPBOC_TRANSACTION_PROPERTY = '3000';
			QPBOC_EC_BALANCE = '000000005000';
			issuer_key = CRYPTO_RSA_1024;
			ic_key = CRYPTO_RSA_1024;
		...
		case 4:
			QPBOC_CARD_ADDITIONAL_PROCESS = '2B00F000';
			QPBOC_TRANSACTION_PROPERTY = '3000';
			QPBOC_EC_BALANCE = '000000005000';
			issuer_key = CRYPTO_RSA_1024;
			ic_key = CRYPTO_RSA_1024;
		...
		case 9:
			QPBOC_CONSECUTIVE_TRANSACTION_LIMIT_INTERNATIONAL_CURRENCY = '05';
			QPBOC_CARD_ADDITIONAL_PROCESS = '8C003000';
			QPBOC_TRANSACTION_PROPERTY = '3000';
			QPBOC_EC_BALANCE = '000000005000';
			issuer_key = CRYPTO_RSA_1024;
			ic_key = CRYPTO_RSA_1024;
		...
		case 36:
			QPBOC_CARD_ADDITIONAL_PROCESS = '81000000';
			QPBOC_EC_RESET_THRESHOLD = '000000000900';
			issuer_key = CRYPTO_RSA_1024;
			ic_key = CRYPTO_RSA_1024;
			break;
				
		case 37:
			CUMULATIVE_TOTAL_TRANSACTION_AMOUNT_LIMIT = '000000007000';
			CUMULATIVE_TOTAL_TRANSACTION_AMOUNT_UPPER_LIMIT = '000000008000';
			QPBOC_CARD_ADDITIONAL_PROCESS = '41000000';
			QPBOC_EC_RESET_THRESHOLD = '000000000900';
			QPBOC_EC_BALANCE_LIMIT = '000000005000';
			issuer_key = CRYPTO_RSA_1024;
			ic_key = CRYPTO_RSA_1024;
			break;
		...
		case 38:
			CUMULATIVE_TOTAL_TRANSACTION_AMOUNT_LIMIT = '000000007000';
			QPBOC_CARD_ADDITIONAL_PROCESS = '21000000';
			QPBOC_EC_RESET_THRESHOLD = '000000000900';
			QPBOC_EC_BALANCE = '000000005000';
			issuer_key = CRYPTO_RSA_1024;
			ic_key = CRYPTO_RSA_1024;
		...
		case 39:
			QPBOC_CARD_ADDITIONAL_PROCESS = '00007000';
			issuer_key = CRYPTO_RSA_1024;
			ic_key = CRYPTO_RSA_1024;
			break;
				
		case 40:
			QPBOC_CARD_ADDITIONAL_PROCESS = '01400000';
			issuer_key = CRYPTO_RSA_1024;
			ic_key = CRYPTO_RSA_1024;
			break;
				
		case 41:
			QPBOC_CARD_ADDITIONAL_PROCESS = '90200000';
			issuer_key = CRYPTO_RSA_1024;
			ic_key = CRYPTO_RSA_1024;
			break;
		...
		case 42:
			CUMULATIVE_TOTAL_TRANSACTION_AMOUNT_LIMIT = '000000007000';						
			QPBOC_AVAILABLE_OFFLINE_BALANCE = '000000000000';
			QPBOC_CARD_ADDITIONAL_PROCESS = '40C00000';
			issuer_key = CRYPTO_RSA_1024;
			ic_key = CRYPTO_RSA_1024;
			break;
		...
		case 43:
			CUMULATIVE_TOTAL_TRANSACTION_AMOUNT_LIMIT = '000000007000';
			//QPBOC_EC_TRANSACTION_LIMIT = '000000005000'
			QPBOC_CARD_ADDITIONAL_PROCESS = '40C00000';
			issuer_key = CRYPTO_RSA_1024;
			ic_key = CRYPTO_RSA_1024;
			break;
		...
		case 44:
			QPBOC_CARD_ADDITIONAL_PROCESS = '80800000';
			issuer_key = CRYPTO_RSA_1024;
			ic_key = CRYPTO_RSA_1024;
			break;
		...
		case 45:
			...
			QPBOC_CARD_ADDITIONAL_PROCESS = '00009000';
			issuer_key = CRYPTO_RSA_1024;
			ic_key = CRYPTO_RSA_1024;
			break;
		...
		case 46:
			QPBOC_AVAILABLE_OFFLINE_BALANCE = '000000000001';
			QPBOC_CARD_ADDITIONAL_PROCESS = '0200C000';
			issuer_key = CRYPTO_RSA_1024;
			ic_key = CRYPTO_RSA_1024;
			break;
				
		case 47:
			// Key Data in Master Spec
			QPBOC_EC_BALANCE = '000000002000';
			QPBOC_AVAILABLE_OFFLINE_BALANCE = '000000000001';
			QPBOC_CARD_ADDITIONAL_PROCESS = '80000000';
		...
		case 48:
			CUMULATIVE_TOTAL_TRANSACTION_AMOUNT_LIMIT = '000000007000';
			QPBOC_AVAILABLE_OFFLINE_BALANCE = '000000000001';
			QPBOC_CARD_ADDITIONAL_PROCESS = '41C00000';
			issuer_key = CRYPTO_RSA_1024;
			ic_key = CRYPTO_RSA_1024;
			break;
